//program to inserting an employee name and salary and increase percentage of salary
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String name = input.nextLine();     //user input of employee name
        em.GetName(name);

        System.out.println("enter the employee salary :");
        double salary = input.nextDouble(); //user input of employee salary
        em.GetSalary(salary);


        System.out.println("enter the percentage of increase on the salary :");
        int raise =input.nextInt();        // user input of increase percentage of salary
        em.RaisSalary(raise);
